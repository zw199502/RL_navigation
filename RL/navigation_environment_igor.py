...
class Env:
    def __init__(self):
        ...
        self.angle_to_velocity = 0.6 # version1
        ...
        self.linear_acc_max = 0.6 # version one
    ...
    def GlobalPathCallback(self, path_data):
        ...
        # sub_pose.pose.position.x = 0.
        # sub_pose.pose.position.y = 0.
        # sub_pose.pose.position.z = 0.
        # sub_pose.pose.orientation.x = 0.
        # sub_pose.pose.orientation.y = 0.
        # sub_pose.pose.orientation.z = 0.
        # sub_pose.pose.orientation.w = 1
        # pub_cmd_sub_pos = rospy.Publisher("/move_base_simple/sub_goal", PoseStamped, queue_size=5)
        # sub_pose.pose.position.x = self.sub_goal_position[0]
        # sub_pose.pose.position.y = self.sub_goal_position[1]
        # pub_cmd_sub_pos.publish(sub_pose)
    ...
    def getState(self, scan):
        ...
        if rel_dis_final_goal <= self.threshold_arrive or self.current_step == 600:
            arrive = True
    ...
    def step(self, action):
        ...
        reward = reward + 250.0 * rel_dis_delta
