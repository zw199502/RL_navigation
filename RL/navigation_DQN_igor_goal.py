...
from navigation_environment_5_igor_goal import Env
        ...
        for ep in range(max_episodes):
            ...
            while ((not done) and (not arrive)):
                ...
                if self.time_step % 40000 == 0 and self.time_step > 0:
                    self.save_model("model/navigation_5_goal/igor/dqn_time_step_{}.h5".format(self.time_step))
            ...
            if ep % 100 == 0 and ep > 0:
                fn = 'model/navigation_5_goal/igor/dqn_episode_' + str(ep) + '.txt'
